...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 21 Bulan Mei 2020 pada 09.40
...
(1, 2, 1, '2020-02-02', '120/60', 'Tifus', 'Demam Tinggi', 'Demam Berdarah', 'Infus', 'mm', 'Suntik', 2, 2),
(2, 7, 1, '2020-02-02', '', '', '', 'Jantung Koroner', 'Kemoterapi', '', 'Kunyit Asam', 2, 1),
(3, 7, 2, '2020-02-02', '', '', '', '', '', '', '', 1, 1),
(4, 8, 1, '2020-02-02', '', '', '', '', '', '', '', 3, 1),
(5, 8, 2, '2020-02-02', '', '', '', '', '', '', '', 1, 1),
(6, 2, 1, '2020-02-03', '120/60', 'amry', 'zulfa', 'Anemia', 'Suntik', 'kk', 'Panadol', 2, 1),
(7, 7, 1, '2020-02-03', '120/60', 'panas dalam', 'tenggorokan kering', 'diabetes', 'suntik', '1x3', 'Bodrex', 2, 1),
(8, 8, 1, '2020-02-03', '', '', '', '', '', '', '', 3, 1),
(9, 8, 2, '2020-02-03', '', '', '', '', '', '', '', 1, 1),
(10, 2, 2, '2020-02-03', '', '', '', '', '', '', '', 1, 1),
(11, 6, 2, '2020-02-03', '', '', '', '', '', '', '', 1, 1);
...
(1, 1, '503/A.0/0066.ADM/35', 'Amry Zulfa Al Husna', 'L', 'Kediri', '1999-08-17', '082234121604', 'Dsn Bulurejo RT.02 RW.01 Ds Kawedusan Kec. Plosoklaten Kab.Kediri', 'amryzoelfa@gmail.com', 'Swasta', 'admin', '123', '130120202257590 Pas Foto Ukuran 4 x 6 cm.jpg'),
...
--
ALTER TABLE `tb_periksa`
  MODIFY `id_periksa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
